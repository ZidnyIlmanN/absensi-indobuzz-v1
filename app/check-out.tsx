      ...
      <View style={styles.content}>
        ...
        <View style={styles.statusCard}>
          ...
          >
            ...
            <Text style={styles.statusSubtitle}>
              You've been working for {state.workHours} today. Time to wrap up!
            </Text>
        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryItem}>
            ...
            <Text style={styles.summaryValue}>{state.workHours}</Text>
          </View>
        ...
        >
          ...
          >
            ...
            <Text style={styles.clockOutButtonText}>
              {isLoading ? 'Processing...' : 'Take Selfie & Clock Out'}
            </Text>
          </LinearGradient>
        </TouchableOpacity>
      </View>
