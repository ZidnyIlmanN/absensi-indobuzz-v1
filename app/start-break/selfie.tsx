...
export default function StartBreakSelfieScreen() {
  const insets = useSafeAreaInsets();
  const { user, addActivity, currentAttendance, updateAttendanceStatus, setCurrentStatus } = useAppContext();
      ...
      <View style={styles.container}>
        ...
        <LinearGradient
          ...
          <View style={styles.headerContent}>
            ...
            <Text style={styles.headerTitle}>Start Break Selfie</Text>
        ...
        <View style={styles.previewContainer}>
          ...
          <View style={styles.previewOverlay}>
            <View style={styles.previewHeader}>
              <Text style={styles.previewTitle}>Break Confirmation</Text>
              <Text style={styles.previewSubtitle}>
                Verify your identity to start break
              </Text>
            </View>
                ...
                >
                  {isProcessing ? (
                    ...
                    <>
                      ...
                      <Text style={styles.submitButtonText}>Confirm Break</Text>
                    </>
                  )}
                </LinearGradient>
              </TouchableOpacity>
        ...
        <View style={styles.cameraContainer}>
          ...
          <View style={styles.instructionsContainer}>
            <View style={styles.instructionsCard}>
              ...
              <Text style={styles.instructionsText}>
                Position your face in the center and tap to capture your break selfie
              </Text>
            </View>
          </View>
          ...
          <View style={styles.controlsContainer}>
            ...
            <Text style={styles.captureHint}>
              Tap to capture your break selfie
            </Text>
          </View>
        </View>
      )}
